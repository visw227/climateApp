...
public class WeatherController extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPress = findViewById(R.id.pressure);
...
//    }
    ...
    private void  getWeatherForNewZip(String city){

        Log.d(LOGCAT_TAG, "Getting weather for zip");
        RequestParams params = new RequestParams();
        params.put("zip",city);
        params.put(null,"us");
        params.put("appid",APP_ID);
    ...
    private void updateUI(WeatherDataModel weather) {
        ...
        mWind.setText(weather.getmWind());
        mCloud.setText(weather.getmCloud());
